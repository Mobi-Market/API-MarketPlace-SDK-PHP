...
class FulfilmentSupplyOrderReportListResponse extends iResponse
{
     ...
     */
    public function setFulfilmentSupplyOrderReportListResult($fulfilmentSupplyOrderReportListResult): void
    {
    ...
    private function generateGetFulfilmentSupplyOrderReportListResult(): void
    {
